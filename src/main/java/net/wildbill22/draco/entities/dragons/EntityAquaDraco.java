...
public class EntityAquaDraco extends EntityFlyingMob implements IMob
{
	...
	public static final String name = "waterDragon";

    public EntityAquaDraco(World p_i1735_1_)
    {
        super(p_i1735_1_);
