...
public class EntityDracoAquila extends EntityFlyingMob implements IMob
{
	...
	public static final String name = "eagleDragon";

    public EntityDracoAquila(World p_i1735_1_)
    {
        super(p_i1735_1_);
