...
public class EntityDracoIgnis extends EntityFlyingMob implements IMob
{
	...
	public static final String name = "fireDragon";

    public EntityDracoIgnis(World p_i1735_1_)
    {
        super(p_i1735_1_);
