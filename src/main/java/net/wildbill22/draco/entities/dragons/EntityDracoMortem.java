...
public class EntityDracoMortem extends EntityFlyingMob implements IMob
{
	...
	public static final String name = "dracoMortem";

    public EntityDracoMortem(World p_i1735_1_)
    {
        super(p_i1735_1_);
