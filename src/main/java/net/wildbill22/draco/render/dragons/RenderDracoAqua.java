...
public class RenderDracoAqua extends RendererLivingEntity  implements IDragonRendererCreationHandler {
	protected ModelDracoAqua model;
	protected ResourceLocation dragonTexture;
	
	public RenderDracoAqua(ModelBase par1ModelBase, float par2) {
