...
//		setRotation(neckSpikes, -0.4363323F, 0F, 0F);
		...
		head.addBox(-4F, -2F, -8F, 8, 4, 8);   // top mouth
		head.addBox(-4F, -0.5F, -8F, 8, 1, 8); // bottom mouth
		...
		// Mouth (for now, will just be part of head)
...
//		setRotation(bottomMouth, 0F, 0F, 0F);
		...
		// Right Wing inner (1, 3) and outer (2, 4)
		...
		rWing3.setRotationPoint(-9F, 0F, -11F);
		...
		rWing2.setRotationPoint(-35.4F, 0F, -11F);
		...
		lWing3.setRotationPoint(3F, 0F, -11F);
		...
		lWing2.setRotationPoint(29.4F, 0F, -11F);
		...
		lWing4.setRotationPoint(29.4F, 0F, -11F);
