...
public class REFERENCE 
{
	...
	// EnchiridionAPI
	public static final String EAPIMODID = "Enchiridion2";
	public static final String enchiridionItemBookName = "book";
	public static final String dracoAnimusBookName = "Draco_Animus";
}
